    ...
    return (
        <StyledCard head={(
            ...
            <StyledContent>
                {!account && (
                    <>
                        <StyledGuestMessage variant="caption" color="#545864">{t('mintCard.guest.message')}</StyledGuestMessage>
                        <StyledSubmitButton onClick={() => activateBrowserWallet()}>{t('mintCard.guest.connectButton')}</StyledSubmitButton>
                    </>
                )}
                {account && (
                    <>
                        ...
                        <StyledPreview>
                            ...
                            <StyledPreviewAmount>
                                ...
                                <Typography variant="header2">{0}</Typography>
                            </StyledPreviewAmount>
                            <StyledPreviewNote>
                                {token === 'DAI' && (
                                    <>
                        ...
                        <StyledPreviewDetails>
                            ...
                            {currentLevel !== newLevel && (
                                <StyledLevel>Level {currentLevel} {`->`} Level {newLevel}</StyledLevel>
                            )}
                        </StyledPreviewDetails>
                        <StyledAgreement>
                            <Checkbox checked={agree} onChange={() => setAgree(!agree)} />
                            <div>
                                {t('mintCard.agreementNote')}
                            </div>
                        </StyledAgreement>
                        <StyledSubmitButton
                            onClick={() => mint(amount)}
                            disabled={amount.eq(0) || !agree}>
