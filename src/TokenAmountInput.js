        ...
        <StyledContainer>
            ...
            <StyledFooter>
                <StyledCurrentBalance color="#000">
                    <span>{t('tokenAmountInput.balance', { balance: trim(formatUnits(balance, decimals[token]), 2), token })}</span>
                    <StyledIcon small src={tokenIcons[token]} />
                </StyledCurrentBalance>
                <Typography variant="caption" color="#545864">{t('tokenAmountInput.maxAmountNote')}</Typography>
            </StyledFooter>
        </StyledContainer>
    )
}
    ...
    return (
        <StyledDropdownOption onClick={() => onSelect(token)}>
            ...
            <StyledDropdownOptionDetail>
                <Typography variant="header2">{token}</Typography>
                <Typography variant="caption" color="#545864">{formatUnits(balance, decimals[token])} {token}</Typography>
            </StyledDropdownOptionDetail>
